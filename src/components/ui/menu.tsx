...
const MenuContent = <T extends object>({ className, placement, popover, ...props }: MenuContentProps<T>) => {
    return (
        <PopoverContent
            ...
            {...popover}
        >
            <MenuPrimitive className={menuContentStyles({ className })} data-slot='menu-content' {...props} />
        </PopoverContent>
    )
}
...
const MenuSection = <T extends object>({ className, children, ref, ...props }: MenuSectionProps<T>) => {
    return (
        <MenuSectionPrimitive className={section({ className })} data-slot='menu-section' ref={ref} {...props}>
