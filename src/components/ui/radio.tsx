...
import { composeRenderProps, RadioGroup as RadioGroupPrimitive, Radio as RadioPrimitive } from 'react-aria-components'
...
export function RadioLabel(props: React.ComponentProps<typeof Label>) {
    return <Label data-slot='control-label' elementType='span' {...props} />
}
