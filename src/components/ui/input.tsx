...
import { Group, type GroupProps, Input as InputPrimitive, type InputProps } from 'react-aria-components'
    ...
    return (
        <Group
            className={cx(
                ...
                '[&>[data-slot=icon]:first-child]:inset-s-3 sm:[&>[data-slot=icon]:first-child]:start-2.5 [&>[data-slot=icon]:last-child]:end-3 sm:[&>[data-slot=icon]:last-child]:end-2.5',
...
export function InputPassword({ placeholder }: { placeholder?: string }) {
