...
const Navbar = ({
    ...
    return (
        ...
        >
            ...
            >
                <div className='mx-auto w-full max-w-(--breakpoint-2xl) items-center md:flex' data-navbar='content'>
                    {children}
                </div>
            </div>
        </div>
...
const NavbarSpacer = ({ className, ref, ...props }: React.ComponentProps<'div'>) => {
    return <div className={twMerge('-ms-4 flex-1', className)} ref={ref} {...props} />
}

const NavbarStart = ({ className, ref, ...props }: React.ComponentProps<'div'>) => {
    return <div className={twMerge('relative p-2 py-4 md:p-0.5', className)} ref={ref} {...props} />
}

const NavbarGap = ({ className, ref, ...props }: React.ComponentProps<'div'>) => {
    return <div className={twMerge('mx-2', className)} ref={ref} {...props} />
}
...
const NavbarLabel = ({ className, ...props }: React.ComponentProps<'span'>) => {
    return (
        <span className={twJoin('col-start-2 row-start-1 truncate', className)} data-slot='navbar-label' {...props} />
    )
}
